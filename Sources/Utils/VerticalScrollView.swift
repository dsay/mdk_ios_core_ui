...
/// A vertical scroll view that stretches content horizontally and allows scrolling only vertically
class VerticalScrollView: UIScrollView {
    ...
    private func setupView() {
        ...
        NSLayoutConstraint.activate([
            ...
            // Content width equals scroll view width (no horizontal scrolling)
